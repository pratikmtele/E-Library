...
# get category id from the GET request
$category_id = $_GET['id'];
...
$books = getBookByCategoryId($conn, $category_id);
...
$current_category = get_Category($category_id, $conn);
...
<body>
    ...
    <div class="container-fluid m-0 p-0">
        <h1 class="display-4 p-3 fs-4"><a href="index.php"><img src="images/left-arrow.png" alt="Back" width="35px"></a>
            <?= $current_category['name'] ?>
        </h1>
        <!-- search Books -->
                ...
                <div class="d-flex m-2">
                    <?php if ($books == 0) { ?>
                        <div class="alert alert-warning p-4 text-center pdf-list" role="alert">
                            ...
                            <p></b> didn't match to any record.</p>
                        </div>
                    <?php } else { ?>
                                ...
                                <div class="card m-2">
                                    ...
                                    <?php if (
                                        ...
                                        <div class="d-flex buttons m-1">
                                            <a href="uploads\files\<?= $book['filename'] ?>" target="_blank"
